...
public final class ChromaticParticles {
  ...
  public static void addLandingEffects(final IBlockState state, final WorldServer world, final BlockPos pos, final EntityLivingBase entity, final int count, final boolean emissive) {
  ...
  public static void addRunningEffects(final Random rand, final IBlockState state, final World world, final BlockPos pos, final Entity entity, final boolean emissive) {
